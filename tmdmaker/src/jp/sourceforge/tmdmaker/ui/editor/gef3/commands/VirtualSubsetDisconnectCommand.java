...
public class VirtualSubsetDisconnectCommand extends Command {
	...
	private Rectangle oldTypeRectangle;
	...
	public VirtualSubsetDisconnectCommand(VirtualSuperset superset, AbstractEntityModel model) {
		...
		this.oldTypeRectangle = ConstraintConverter.getRectangle(superset.getVirtualSupersetType());
		this.model = model;
	}
	...
	public void undo() {
		...
		ConstraintConverter.setConstraint(superset.getVirtualSupersetType(), oldTypeRectangle);
	}
}
