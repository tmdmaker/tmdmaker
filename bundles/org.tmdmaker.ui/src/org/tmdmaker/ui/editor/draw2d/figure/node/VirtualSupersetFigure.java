...
/**
 * VirtualSupersetのFigure.
 * 
 * @author nakag
 *
 */
public class VirtualSupersetFigure extends AbstractModelFigure<VirtualSuperset> {
	 ...
	 */
	@Override
	protected ModelAppearance getAppearance(VirtualSuperset model) {
	 ...
	 */
	@Override
	protected String getTypeLabel(VirtualSuperset model) {
