...
/**
 * XStreamを使ったダイアグラ�??シリアライズ・�?��リアライズ用クラス
 * 
 * @author nakaG
 * 
 */
public class XStreamSerializer implements Serializer {
	 ...
	 * @param obj
	 *            �?��アグラ�?	 * @param loader
	 *            クラスロー�?	 * @return �?��アグラ�??入力ストリー�?	 * @throws UnsupportedEncodingException
	 */
	 ...
	 * 
	 * @param in
	 *            �?��アグラ�??入力ストリー�?	 * @param loader
	 *            クラスロー�?	 * @return �?��アグラ�?	 * @throws UnsupportedEncodingException
	 */
